...
This repo is a practical playbook for building a community club that is legal, welcoming, digitally organised, and light enough that it does not burn out one person.
...
Those repos are site and project concepts. This repo is the club-building operating model that could support a sand sports idea without merging the site stories together.
...
That checks the guide has its expected files and scans for local path leakage before anything is shared publicly.
